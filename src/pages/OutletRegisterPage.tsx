    ...
    useEffect(() => {
      const fetchOptions = async () => {
        try {
          ...
          setAvailableOptions({
            taps: options.outletRegister.taps,
            salesforces: options.outletRegister.salesforces,
            pjps: options.outletRegister.pjps,
            kabupatens: options.outletRegister.kabupatens,
            kecamatans: options.outletRegister.kecamatans,
          });
        } catch (error) {
